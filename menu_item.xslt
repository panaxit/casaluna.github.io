...
>
	...
	<xsl:template match="notifications" mode="icon">
		<xsl:attribute name="xo-store">#notifications</xsl:attribute>
	...
	<xsl:template match="/*">
		...
		<a class="btn dropdown-toggle position-relative" href="#" role="button" id="item_{name()}" data-bs-toggle="dropdown" aria-expanded="false">
