...
>
	...
	<xsl:key name="dataset" match="px:Association/px:Entity/data:rows/xo:r/@meta:text" use="concat(ancestor::px:Entity[2]/@xo:id,'::meta:',ancestor::px:Association[1]/@Name)"/>
	<xsl:key name="dataset" match="px:Association/px:Entity/data:rows[not(@xsi:nil) and not(xo:r)]/@xo:id" use="concat(ancestor::px:Entity[2]/@xo:id,'::meta:',ancestor::px:Association[1]/@Name)"/>
