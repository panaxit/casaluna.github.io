...
Object.defineProperty(xover.listener, 'dispatcher', {
    value: async function (event) {
        ...
        for (let handler of [...handlers.values()].reverse()) {
            ...
            if (event.propagationStopped || (event.srcEvent || {}).propagationStopped) break;
...
xover.listener.on(['change::*[xo-attribute]:not([type*="time"]):not([type*="date"])', 'focusout::*[xo-attribute][type*="time"]', 'focusout::*[xo-attribute][type*="date"]'], function () {
