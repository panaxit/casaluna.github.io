...
.menu .badge {
	...
	<xsl:template match="notifications|messages" mode="store">
		<xsl:attribute name="xo-store">#<xsl:value-of select="name()"/></xsl:attribute>
	</xsl:template>
	...
	<xsl:template match="/menus/*">
		...
		<div class="dropdown">
			...
			<a class="btn dropdown-toggle position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
