...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  exclude-result-prefixes="xo state xsl xsi form cardview data height width data container px readonly layout meta"
>
	...
	<xsl:template mode="widget" match="@*">
		...
		<input type="text" class="form-control" id="{$schema/@xo:id}" placeholder="" required="" xo-scope="{$current/../@xo:id}" xo-attribute="{name()}">
